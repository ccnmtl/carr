...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Case'
        db.create_table('activity_taking_action_case', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=25)),
        ))
        db.send_create_signal('activity_taking_action', ['Case'])

        # Adding model 'Block'
        db.create_table('activity_taking_action_block', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('activity_taking_action', ['Block'])

        # Adding model 'ActivityState'
        db.create_table('activity_taking_action_activitystate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='taking_action_user', to=orm['auth.User'])),
            ('json', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('activity_taking_action', ['ActivityState'])


    def backwards(self, orm):
        
        # Deleting model 'Case'
        db.delete_table('activity_taking_action_case')

        # Deleting model 'Block'
        db.delete_table('activity_taking_action_block')

        # Deleting model 'ActivityState'
        db.delete_table('activity_taking_action_activitystate')


    models = {
        'activity_taking_action.activitystate': {
            'Meta': {'object_name': 'ActivityState'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'json': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'taking_action_user'", 'to': "orm['auth.User']"})
        },
    ...
    complete_apps = ['activity_taking_action']
