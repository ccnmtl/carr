...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('quiz_activitystate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='quiz_user', to=orm['auth.User'])),
            ('json', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('submitted', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('quiz', ['ActivityState'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('quiz_activitystate')
    ...
    models = {
        ...
        'quiz.activitystate': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'quiz_user'", 'to': "orm['auth.User']"})
        },
        'quiz.answer': {
