...
urlpatterns = patterns(
    ...
    (r'^scores/$', 'carr.quiz.scores.scores_index'),
    (r'^scores/socialwork$',
     'carr.quiz.scores.scores_index'),
    (r'^scores/socialwork/$',
     'carr.quiz.scores.scores_index'),

    # a list of years
    (r'^scores/socialwork/year/$',
     'carr.quiz.scores.socialwork_overview'),

    # a list of semesters for each year
    (r'^scores/socialwork/year/(?P<year>\d+)/$',
    ...
    (r'^scores/student/$',
     'carr.quiz.scores.scores_student'),

    # a list of students for each class
    ((r'^scores/socialwork/course/(?P<c1>\w+)/(?P<c2>\w+)/'
