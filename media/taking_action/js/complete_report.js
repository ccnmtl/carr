...
function show_expert_form() {
    ...
    updateNodeAttributes($('scrolling_ldss_form'), {'style': { 'background-image': 'url(../img/expert_ldss.png)'}});
    $('show_or_hide').innerHTML = "Hide"
}

function hide_expert_form () {
    map (showElement , $$('.positioner_div'))
    updateNodeAttributes($('scrolling_ldss_form'), {'style': { 'background-image': 'url(../img/ldss.png)'}});
