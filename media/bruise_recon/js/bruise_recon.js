function validate() {
    ...
    return (hasElementClass($('answer_yes'), 'button_selected') || hasElementClass(
            $('answer_no'), 'button_selected'));
}
...
function disable_all_sidenav_items_after_current_one() {
    ...
    sidenav_items_to_disable = all_sidenav_items.slice(all_sidenav_items
...
function answer_is_correct() {
    ...
    factors_include_severity = ($('correct_factors').innerHTML.toLowerCase()
            .match(/severity/)) != null
    factors_include_location = ($('correct_factors').innerHTML.toLowerCase()
            .match(/body location/)) != null
    factors_include_patterns = ($('correct_factors').innerHTML.toLowerCase()
            .match(/patterns/)) != null
    factors_include_explanation = ($('correct_factors').innerHTML.toLowerCase()
            .match(/explanation/)) != null

    answer_includes_severity = (hasElementClass($('severity'),
            'button_selected'))
    answer_includes_location = (hasElementClass($('body location'),
            'button_selected'))
    answer_includes_patterns = (hasElementClass($('patterns'),
            'button_selected'))
    answer_includes_explanation = (hasElementClass($('explanation'),
            'button_selected'))
    ...
    /*
     * if ( factors_include_severity && ! answer_includes_severity ) { return
     * false }; if ( factors_include_location && ! answer_includes_location ) {
     * return false }; if ( factors_include_patterns && !
     * answer_includes_patterns ) { return false }; if (
     * factors_include_explanation && ! answer_includes_explanation ) { return
     * false }; if ( ! factors_include_severity && answer_includes_severity ) {
     * return false }; if ( ! factors_include_location &&
     * answer_includes_location ) { return false }; if ( !
     * factors_include_patterns && answer_includes_patterns ) { return false };
     * if ( ! factors_include_explanation && answer_includes_explanation ) {
     * return false };
     */
    // }
